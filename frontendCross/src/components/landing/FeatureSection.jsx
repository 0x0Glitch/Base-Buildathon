      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-slate-300">
            Our cutting-edge bridge combines smart contract automation with AI
            agents to create the most secure and efficient cross-chain
            experience
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <FeatureCard
            ...
            description="Leverage our automated smart contracts for improved interoperability, reducing gas costs and increasing transfer speed across blockchains."
          />
          <FeatureCard
            icon={Shield}
