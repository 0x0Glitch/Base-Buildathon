      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-slate-300">
            Join thousands of satisfied users who trust our bridge for their
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <FrostedCard>
            <div className="flex flex-col h-full">
              <div className="flex-1">
                <p className="text-slate-300">
                  "Orion has completely transformed how I move assets between
                  blockchains. The AI-powered security gives me confidence that
                  my funds are safe."
                </p>
              </div>
          ...
          <FrostedCard>
            <div className="flex flex-col h-full">
              <div className="flex-1">
                <p className="text-slate-300">
                  "The speed of transfers is incredible. What used to take hours
                  now completes in minutes, and the gasless transactions save me
                  a fortune."
                </p>
              </div>
              <div className="mt-6 pt-6 border-t border-white/10">
          ...
          <FrostedCard>
            <div className="flex flex-col h-full">
              <div className="flex-1">
                <p className="text-slate-300">
                  "As someone who works across multiple blockchains,
                  Orion-Network has become an essential tool in my daily
                  workflow. The UI is intuitive and the service is reliable."
                </p>
              </div>
              <div className="mt-6 pt-6 border-t border-white/10">
                <div className="flex items-center">
